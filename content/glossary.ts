...
export const GLOSSARIO: TermineGlossario[] = [
...

  {
    ...
    categoria: 'iva',
    origine: 'La differenza tra l\'IVA che hai fatturato ai clienti (IVA a debito verso erario) e quella che ti è stata fatturata dai fornitori (IVA a credito)',
    definizione: 'Ogni SAL fatturato con IVA 10% genera un debito IVA verso l\'Erario fin dal MESE DI FATTURA — non dal mese in cui il cliente paga davvero. L\'azienda è in regime ordinario (volume d\'affari sopra soglia, non "IVA per cassa"), quindi l\'IVA segue la data fattura (esigibilità), non la data di incasso: un SAL fatturato a dicembre ma incassato a gennaio conta nell\'IVA di dicembre. Puoi scalare l\'IVA che ti è stata fatturata dai fornitori. Il saldo è quello che devi versare con l\'F24 periodico (quello sì, legato alla data di versamento effettivo).',
    formulaTestuale: 'Saldo IVA = IVA a debito su fatture emesse (per data fattura) − IVA a credito su fatture ricevute (per data fattura)',
    esempioNumerico: {
      dati: 'SAL €50.000 + IVA 10% €5.000 fatturato a dicembre (incassato a gennaio). Fatture fornitori €30.000 + IVA 22% €6.600 ricevute nello stesso mese',
      calcolo: '5.000 − 6.600',
      risultato: 'Saldo IVA di dicembre = −€1.600 → credito IVA quel mese, a prescindere da quando il SAL verrà davvero incassato',
    },
...

  {
    ...
    definizione: 'È il differenziale tra quanto realizzato finora (Consuntivo YTD) e l\'intero obiettivo annuale fissato a budget — un confronto diretto, senza riproporzionare il target ai mesi già trascorsi dell\'anno. Per i ricavi, un valore positivo indica vantaggio; per i costi, un valore positivo indica che si è ancora sotto il tetto di spesa annuale.',
    formulaTestuale: 'Scostamento = Consuntivo YTD − Budget Annuo (ricavi); Budget Annuo − Consuntivo YTD (costi)',
    esempioNumerico: {
      dati: 'Budget annuo ricavi €120.000. Consuntivo YTD reale ad oggi (a metà anno): €55.000',
      calcolo: '€55.000 − €120.000',
      risultato: 'Scostamento = −€65.000 (ancora sotto l\'obiettivo annuale pieno — normale finché l\'anno non è concluso, non un ritardo rispetto al pro-quota temporale)',
    },
  ...
  {
    id: 'uscite',
    nome: 'Uscite Totali Consuntive',
    categoria: 'concetti',
    origine: 'Flussi di cassa in uscita per pagamenti reali',
    definizione: 'La somma complessiva di tutti i pagamenti reali effettuati nell\'anno fiscale in corso (fornitori, stipendi, tasse, rate mutuo, spese fisse, capex). Non include i costi non monetari come gli ammortamenti e le accantonamenti.',
    formulaTestuale: 'Uscite = Costi Variabili + Costi Fissi + Oneri Finanziari + Capex + Tasse Pagate',
    doveAppareNellApp: ['Dashboard — Widget Uscite', 'ExpenseTimeline'],
  },
  {
    id: 'saldo_cassa',
    nome: 'Saldo Flusso di Cassa Netto',
    categoria: 'concetti',
    origine: 'Net Cash Flow dell\'esercizio',
    definizione: 'La differenza netta tra tutte le entrate totali (incassi di SAL, vendite) e le uscite totali (pagamenti eseguiti) registrate nell\'anno. Rappresenta la liquidità netta prodotta o consumata dalla gestione.',
    formulaTestuale: 'Saldo = Entrate Totali - Uscite Totali',
    doveAppareNellApp: ['Dashboard — Widget Saldo', 'CashFlowTimeline'],
  },
  {
    id: 'spese_categoria',
    nome: 'Ripartizione Spese per Categoria',
    categoria: 'concetti',
    origine: 'Analisi qualitativa delle uscite',
    definizione: 'Grafico a torta che mostra la distribuzione percentuale e in valore assoluto di tutte le uscite registrate nell\'anno, suddivise per categoria contabile, per monitorare quali voci di costo incidono maggiormente sul budget aziendale.',
    doveAppareNellApp: ['Dashboard — Spese per Categoria'],
  },
  {
    id: 'andamento_mensile',
    nome: 'Andamento Mensile delle Spese',
    categoria: 'concetti',
    origine: 'Analisi temporale cash flow',
    definizione: 'Grafico a barre che mostra il confronto storico mensile tra le Entrate totali e le Uscite totali di tutti e 12 i mesi dell\'anno selezionato, consentendo di visualizzare la stagionalità dei flussi e i mesi di picco finanziario.',
    doveAppareNellApp: ['Dashboard — Andamento Mensile'],
  },
  {
    id: 'conto_corrente',
    nome: 'Liquidità Cumulata Conto Corrente',
    categoria: 'rating',
    origine: 'Saldo progressivo di cassa e banca',
    definizione: 'Grafico a linee che mostra l\'andamento progressivo cumulato della liquidità aziendale mese per mese. Parte dal saldo iniziale dei conti correnti all\'inizio dell\'anno e somma algebricamente i flussi netti mensili per mostrare la disponibilità liquida residua.',
    doveAppareNellApp: ['Dashboard — Andamento Conto Corrente'],
  },
  {
    id: 'confronto_entrate',
    nome: 'Confronto Entrate (Consuntivo vs Previsionale)',
    categoria: 'concetti',
    origine: 'Scostamento entrate operative',
    definizione: 'Grafico composto che mette a confronto le entrate realmente incassate (consuntive) rispetto alle entrate pianificate (previsionali) mese per mese, per verificare il tasso di raggiungimento degli obiettivi di fatturato.',
    doveAppareNellApp: ['Dashboard — Confronto Entrate'],
  },
  {
    id: 'confronto_uscite',
    nome: 'Confronto Uscite (Consuntivo vs Previsionale)',
    categoria: 'concetti',
    origine: 'Scostamento uscite e costi',
    definizione: 'Grafico composto che mette a confronto le uscite reali effettuate (consuntive) con le uscite pianificate (previsionali) mese per mese, aiutando a rilevare scostamenti di costo o sforamenti di budget.',
    doveAppareNellApp: ['Dashboard — Confronto Uscite'],
  },
  {
    id: 'costi_fissi',
    nome: 'Costi Fissi di Struttura',
    categoria: 'ce',
    origine: 'Overhead aziendali indipendenti dai volumi',
    definizione: 'I costi di struttura stabili che l\'azienda sostiene a prescindere dal volume di produzione o dal numero di cantieri attivi (es. affitto uffici, stipendi impiegati, utenze, assicurazioni, software, commercialista).',
    doveAppareNellApp: ['Dashboard — Costi Fissi', 'CEView', 'ExpenseTimeline'],
  },
  {
    id: 'costi_variabili',
    nome: 'Costi Variabili di Produzione',
    categoria: 'ce',
    origine: 'Costi diretti di commessa legati ai volumi',
    definizione: 'I costi che variano in maniera direttamente proporzionale all\'attività produttiva o al numero di cantieri in corso (es. materiali edili, subappalti, carburante mezzi, attrezzature specifiche, operai di cantiere, oneri di cantiere).',
    doveAppareNellApp: ['Dashboard — Costi Variabili', 'CEView', 'ExpenseTimeline'],
  },
  {
    id: 'rating_bancario',
