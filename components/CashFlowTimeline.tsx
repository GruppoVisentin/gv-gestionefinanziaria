...
const CashFlowTimeline: React.FC<CashFlowTimelineProps> = ({ 
  ...
  const COL_LABEL_WIDTH = "min-w-[140px] w-[140px] max-w-[140px]";
  const COL_MONTH_WIDTH = "min-w-[240px] w-[240px]";
  const COL_SUB_WIDTH = "w-[120px]";
  const COL_SUMMARY_WIDTH = "w-[70px]";
  ...
  return (
    <div className="bg-[#222222] rounded-2xl shadow-lg border border-slate-800 flex flex-col animate-in fade-in duration-500 mt-4 overflow-hidden relative">
      ...
      <div id="cashflow-timeline-report-content">
        ...
        <table className="w-full text-sm text-left border-collapse" style={{ tableLayout: 'fixed', minWidth: 3160 }}>
          <colgroup>
            <col style={{ width: 140 }} />
          ...
          <thead className="text-xs uppercase bg-slate-800 text-slate-400 sticky top-0 z-30">
            ...
            <tr>
              ...
              <th className={`px-2 py-2 border-l-2 border-slate-700 border-r border-slate-700 text-slate-500 font-bold text-center bg-slate-800 sticky right-[70px] z-30 shadow-[-4px_0_4px_-2px_rgba(0,0,0,0.3)] ${COL_SUMMARY_WIDTH}`}>
                Tot. Prev.
              </th>
          ...
          <tbody>
            <tr className="bg-[#222222]/50 hover:bg-slate-800/30 transition-colors">
              ...
              <td className={`px-2 py-4 text-center border-l-2 border-slate-700 border-r border-slate-700 text-slate-400 font-mono text-xs bg-slate-900/50 font-bold sticky right-[70px] z-10 shadow-[-4px_0_4px_-2px_rgba(0,0,0,0.3)] ${COL_SUMMARY_WIDTH}`}>
            ...
            {/* Grand Total Row (Cumulative Balance) */}
             <tr className="bg-slate-950 font-bold border-t-2 border-slate-700">
              ...
              <td className={`px-2 py-4 text-center border-l-2 border-slate-700 border-r border-slate-700 text-slate-400 font-mono text-xs bg-slate-900/50 font-bold sticky right-[70px] z-30 shadow-[-4px_0_4px_-2px_rgba(0,0,0,0.3)] ${COL_SUMMARY_WIDTH}`}>
